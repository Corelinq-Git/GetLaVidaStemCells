...
export default function SqueezePage() {
  ...
  return (
    <section className="relative h-svh w-full overflow-hidden bg-ocean-deepest text-cream">
      ...
      {/* Top bar */}
      <div className="absolute top-0 left-0 right-0 z-20 px-5 md:px-10 py-4 flex items-center justify-between">
        <motion.div
        ...
        >
          ...
          />
          <span className="hidden md:inline text-xs text-cream/55 tracking-[0.22em] uppercase font-medium border-l border-cream/20 pl-3">
      ...
      {/* Main content area */}
      <div className="relative z-10 h-full flex items-center px-5 md:px-10 lg:px-16">
...
function SqueezeCard({ phone, setPhone, name, setName, status, error, onSubmit }: SqueezeCardProps) {
  return (
    <div className="rounded-2xl bg-white text-ocean-deepest p-6 md:p-7 shadow-2xl shadow-black/30 border border-white/40">
      ...
      <p className="mt-3 text-gray-600 leading-relaxed text-sm md:text-base">
        ...
        60 seconds, qualify your case, and book a private consult with our
        medical team in Punta Cana.
      </p>
